            ...
            <div class="row">
                <div class="details-product">
                    <div id="content" class="col-sm-12 col-xs-12 col-md-9 col-md-push-3">
                                                                ...
                                                                <form id="form-review" name="zozoweb-product-reviews-frm">
                                                                    ...
                                                                    <fieldset class="bpr-form-rating">
                                                                        <div id="dvRating" style="cursor: pointer; color: rgb(255, 190, 0);">
                                                                            ...
                                                                            <input type="radio" name="rating" value="5" />&nbsp; Tốt </div>
                                                                    </fieldset>
                                                                    <fieldset class="bpr-form-contact">
                                                                        <div class="bpr-form-contact-name require">
                                                                            <input type="text" maxlength="128" id="review_author" name="name" value="" placeholder="Họ tên">
                                                                        </div>
                                                                        <div class="bpr-form-contact-email require">
                                                                            <input type="text" maxlength="128" id="review_email" name="email" value="" placeholder="Họ tên">
                                                                        </div>
                                                                    </fieldset>
                        ...
                        <hr />
                        <div class="fb-comments" data-href="https://bigboom.myzozo.net/ao-hoodie-nu-chu-theu-thoi-trang-sid53235" data-width="100%" data-numposts="5"></div>
                    </div>
        ...
        $.ajax({
            ...
            success   : function (json) {
                ...
                if (json['success']) {
                    ...
                    $('#cart #cart-sidebar').load('indexe061.html?route=common/cart/info#cart-sidebar > li');
                }
            },
