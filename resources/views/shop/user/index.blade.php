...
@section('detail');
<section class="product" itemscope="" itemtype="http://schema.org/Product" style="margin-bottom: 60px;">
    <div class="container">
                        ...
                        <aside id="column-left" class="left-column compliance dqdt-sidebar sidebar left-content article-sidebar left">
                            <aside class="aside-item sidebar-category collection-category">
                                <div class="aside-title">
                                    <h2 class="title-head margin-top-0" style="text-transform: none;margin-bottom: 20px;">
